<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		<label>
			<?php _e('Import', 'flexity') ?>
		</label>
		<div class="description">
			<p><?php _e('Import Options', 'flexity') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-import" class="vp-button button" type="button" value="<?php _e('Import', 'flexity') ?>" />
...
<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		<label>
			<?php _e('Export', 'flexity') ?>
		</label>
		<div class="description">
			<p><?php _e('Export Options', 'flexity') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-export" class="vp-button button" type="button" value="<?php _e('Export', 'flexity') ?>" />
				<span style="margin-left: 10px;">
